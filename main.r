...
setwd('C:/Users/yasemin/Desktop/fall18-instructor-master')
...
matches_data_path='C:/Users/yasemin/Downloads/df9b1196-e3cf-4cc7-9159-f236fe738215_matches.rds'
odd_details_data_path='C:/Users/yasemin/Downloads/df9b1196-e3cf-4cc7-9159-f236fe738215_odd_details.rds'
...
predictions=train_glmnet(train_features, test_features,not_included_feature_indices=c(1:5), alpha=1,nlambda=50, tune_lambda=TRUE,nofReplications=5,nFolds=10,trace=T)
